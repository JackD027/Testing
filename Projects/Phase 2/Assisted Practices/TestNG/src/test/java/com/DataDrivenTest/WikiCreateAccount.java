...
public class WikiCreateAccount {
	...
	// in testNG we can create a DATA provider method that will fetch data from
	// excel sheet
	// and supply the data to your @Test method
	// this method datatype is going to be an object
