...
public class WriteDataInExcel {
	...
	public static void main(String[] args) throws IOException {
		...
		Object[][] data = { { "Name", "Location" }, { "Shubham", "Allahabad" }, { "Kirti", "Allahabad" },
				{ "Khushi", "Allahabad" } };
...

		{
			...
			XSSFRow row = sheetone.createRow(r); // create a new row in the sheet and retrun a highlevel representation
													// of it
