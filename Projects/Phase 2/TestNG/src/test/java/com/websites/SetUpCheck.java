...
public class SetUpCheck {
	...
	public void extentdemo() {
		...
		// right click on project-->properties-->go to resources on left-->copy the path
		// of project
		// D:\eclipse\ExtentReports
		ExtentSparkReporter sparkreporter = new ExtentSparkReporter("D:\\eclipse\\ExtentReports");
