...
public class HardAssertion {
	...
	// Assertions are a way to validate if your expected output is matching the
	// actual output
	// hard Assertion :
	// When the you check if expected output is matching the actual output ->your
	// testcase continues to run
