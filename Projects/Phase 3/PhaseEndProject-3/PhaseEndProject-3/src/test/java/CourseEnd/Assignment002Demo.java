...
public class Assignment002Demo {
	...
	public void assignment002Post()
	{
		...
		File file = new File("D:\\eclipse\\PhaseEndProject-3\\src\\test\\resources\\data.json");
	...
	{
		File file = new File("D:\\eclipse\\PhaseEndProject-3\\src\\test\\resources\\dataput.json");
		int id = RestAssured.given()
							.baseUri("https://petstore.swagger.io/v2/pet/")
							.contentType(ContentType.JSON)
							.body(file)
