...
public class ImplicitWaitCookies {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		// here selenium is going to wait for full 3 seconds before throwing an error
		// that element not found
		// Even if elements are visible on the webpage, selenium will wait for 3 seconds
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(3));

		// static wait
		// in this case even if element is visible after 2 sec, the seleniums cript si
		// goign to definitly wait
